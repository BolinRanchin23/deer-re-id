"""Append durable per-animal profiling workflow transitions."""

import json
import os
from http.server import BaseHTTPRequestHandler

from reveal_downloader.catalog import handle_hd_review_workflow
...
class handler(BaseHTTPRequestHandler):
    def do_POST(self) -> None:
        ...
        status, result = handle_hd_review_workflow(
            os.environ,
