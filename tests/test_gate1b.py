...
class Gate1BTriageTests(unittest.TestCase):
    ...
    def test_clear_target_deer_without_male_evidence_is_only_a_candidate_for_suppression(self):
        prediction = normalize_prediction({
            "animal_count": 1,
            "species": "whitetail",
            "visible_antler": "no",
    ...
    def test_multiple_animals_require_mixed_group_and_unassessed_if_any_is_unclear(self):
        with self.assertRaises(ValueError):
